...
GateRejectedVolumeMessenger::GateRejectedVolumeMessenger(GateRejectedVolume* itsRejectedVolume) : GatePulseProcessorMessenger(itsRejectedVolume)
{
  G4String guidance;
  G4String cmdName;
...
GateRejectedVolumeMessenger::~GateRejectedVolumeMessenger() { delete rejectVolCmd; }
