...
std::vector<G4int> get_ordering(const std::vector<G4double>& unsorted_array) {
 ...
 if (nVerboseLevel > 2)
  ...
  if (!trajectoryContainer)
  ...
  else
    {
	  ...
	  //////////////////////////////////////////////////////////////////
	  // The following bit used to be part of the loop
	  ...
	  */	  
	  ...
	  if (nVerboseLevel > 1) G4cout << "GateAnalysis::RecordEndOfEvent : photon1ID : " << photon1ID
