 ...
 *
 *  @file GateJPETFiveGammasDecayModel.hh
 */

#ifndef GateJPETFiveGammasDecayModel_HH
#define GateJPETFiveGammasDecayModel_HH
 ...
 */
class GateJPETFiveGammasDecayModel : public GateGammaSourceModel
{
 public:
  virtual~GateJPETFiveGammasDecayModel();
   ...
   * */
  static GateJPETFiveGammasDecayModel *GetInstance();
