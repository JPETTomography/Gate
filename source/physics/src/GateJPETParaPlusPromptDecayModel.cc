 ...
 *
 *  @file GateJPETParaPlusPromptDecayModel.cc
 */

#include "GateJPETParaPlusPromptDecayModel.hh"
...
void GateJPETParaPlusPromptDecayModel::GetGammaParticles(std::vector<G4PrimaryParticle*>& particles)
{
...
GateJPETParaPlusPromptDecayModel* GateJPETParaPlusPromptDecayModel::GetInstance()
{
 if(!ptrJPETParaPlusPromptDecayModel)
  ptrJPETParaPlusPromptDecayModel = new GateJPETParaPlusPromptDecayModel;
